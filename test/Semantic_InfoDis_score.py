...
def gpt4_chatbot_score(path, save_dir, ques_type = "Semantic_InfoDis"):
    ...
    for k, v in tqdm(path.items()):
        ...
        for que_id, chat_answer in ques_list.items():
            ...
            TEXT_SCORE = f"""Here are two answers to the same question "{Question}", and the Answers1 is "{Standard_Answer}", the Answers2 is "{Generated_Answer}". Are the results in Answer 2 and Answer 1 consistent in semantic information? Only answer 'yes' or 'no' without any explanation."""
...
if __name__ == "__main__":
    ...
    test_ques_type = "Semantic_InfoDis"
