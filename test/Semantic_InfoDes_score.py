...
def gpt4_chatbot_score(path, save_dir, ques_type = "Semantic_InfoDes"):
    ...
    for k, v in tqdm(path.items()):
        ...
        for que_id, chat_answer in ques_list.items():
            ...
            TEXT_SCORE = f"""Here are two answers to the same question "{Question}" according to the image, and the Answers1 is "{Standard_Answer}", the Answers2 is "{Generated_Answer}". Please refer to Answer 1 and evaluate Answer 2 for accuracy and conciseness, giving a score between 0 and 10, with accuracy being the most important factor. If the answer is incorrect, the score should be 0; if the answer is accurate and concise, the score can be high, such as 9 or 10; if the answer is accurate but verbose, the score should be lower, such as 5 or 6. Only answer score number without any explanation."""
...
if __name__ == "__main__":
    ...
    test_ques_type = "Semantic_InfoDes"
